// src/components/inventory/ItemInspectorModal.vue (Modified for DOM Fix)
...
<template>
    <Dialog 
        v-model:visible="isInspectorOpen" 
        @update:visible="blockInternalClose" 
        :modal="true" 
        :closable="false"
    ...
    >
        <div v-if="itemToInspect" class="relative bg-surface-900 rounded-xl shadow-2xl flex flex-col h-full"> 
            ...
            <div class="absolute top-0 -left-56 w-52 p-4 bg-surface-800 rounded-lg shadow-xl border border-surface-700 z-10 hidden md:block">
            ...
            <div class="relative p-6 flex-grow overflow-y-auto"> <div class="flex items-center justify-between border-b border-surface-700 pb-3 mb-4">
                    <h2 class="text-3xl font-bold" :class="getQualityColor(itemToInspect.quality)">{{ itemToInspect.name }}</h2>
                    <div class="text-right">
                        <p class="text-surface-400 text-sm italic">{{ itemToInspect.quality }}</p>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div>
                        ...
                        <div v-for="(value, key) in itemToInspect.baseStats" :key="key" class="flex justify-between text-surface-300">
                            <span>{{ key }}</span>
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-4 gap-3">
                            ...
                            >
                                <span v-if="itemToInspect.modSlots[index] === 'filled'" class="font-bold text-lg">MOD</span>
